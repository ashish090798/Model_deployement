...
with open(r'C:\Users\vish\Documents\Data\Deployment\model 1\model24Mar.pkl','rb') as f:
	clf = pickle.load(f)

with open(r'C:\Users\vish\Documents\Data\Deployment\model 1\bin24Mar.pkl','rb') as f:
	binz = pickle.load(f)
